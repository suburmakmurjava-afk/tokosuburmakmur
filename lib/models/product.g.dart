  ...
  switch (propertyId) {
    case 0:
      return (_ProductcategoryValueEnumMap[reader.readStringOrNull(offset)] ??
          ProductCategory.agriculture) as P;
    case 1:
...
const _ProductcategoryEnumValueMap = {
  ...
  r'livestock': r'livestock',
};
const _ProductcategoryValueEnumMap = {
  r'agriculture': ProductCategory.agriculture,
  r'livestock': ProductCategory.livestock,
};
...
extension ProductQueryWhere on QueryBuilder<Product, Product, QWhereClause> {
  ...
  QueryBuilder<Product, Product, QAfterWhereClause> categoryEqualToAnyName(
  ...
  QueryBuilder<Product, Product, QAfterWhereClause> categoryNotEqualToAnyName(
      ProductCategory category) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
